...
def delete():
    ...
    if not selected_item:
        messagebox.showerror('Error','Choosen an employee deleted.')
    else:
        id=id_entry.get()
...
def update():
    selected_item = tree.focus()
    if not selected_item:
        messagebox.showerror('Error','Chooes an employee to update.')
    else:
        id = id_entry.get()
        name = name_entry.get()
        role = role_entry.get()
...
id_label = customtkinter.CTkLabel (app,font=font1,text='ID:',text_color='#161c25')
...
name_label = customtkinter.CTkLabel (app,font=font1,text='Name:',text_color='#161c25')
...
role_label = customtkinter.CTkLabel (app,font=font1,text='Role:',text_color='#161c25')
...
gender_label = customtkinter.CTkLabel (app,font=font1,text='Gender:',text_color='#161c25')
...
status_label = customtkinter.CTkLabel (app,font=font1,text='Status:',text_color='#161c25')
...
add_button = customtkinter.CTkButton (app,command=insert,font=font1,text_color='#fff',text='Add Employee',fg_color='#05A312',hover_color='#00850B',cursor='hand2',corner_radius=15,width=260)
add_button.place(x=20,y=310)

clear_button = customtkinter.CTkButton (app,command=lambda:clear(True),font=font1,text_color='#fff',text='New Employee',fg_color='#161c25',hover_color='#FF5002',border_color='#F15704',border_width=2,cursor='hand2',corner_radius=15,width=260)
clear_button.place(x=20,y=360)

update_button = customtkinter.CTkButton (app,command=update,font=font1,text_color='#fff',text='Update Employee',fg_color='#161c25',hover_color='#FF5002',border_color='#F15704',border_width=2,cursor='hand2',corner_radius=15,width=260)
update_button.place(x=300,y=360)

delete_button = customtkinter.CTkButton (app,command=delete,font=font1,text_color='#fff',text='Delete Employee',fg_color='#E40404',hover_color='#AE0000',border_color='#E40404',border_width=2,cursor='hand2',corner_radius=15,width=260)
